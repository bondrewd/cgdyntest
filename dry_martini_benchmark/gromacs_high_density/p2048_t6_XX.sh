...
input=input
name=p2048_t6_XX
mpiexec -np 2048 -stdout-proc ./output.${PJM_JOBID}_${PJM_STEPNUM}/%/1000r/stdout  -stderr-proc ./output.${PJM_JOBID}_${PJM_STEPNUM}/%/1000r/stderr gmx_mpi mdrun -s ${input}.tpr -g ${name}.log -nsteps 5000
