...
input=input
name=p256_t6_03
mpiexec -np 256 -stdout-proc ./output.${PJM_JOBID}_${PJM_STEPNUM}/%/1000r/stdout  -stderr-proc ./output.${PJM_JOBID}_${PJM_STEPNUM}/%/1000r/stderr gmx_mpi mdrun -s ${input}.tpr -g ${name}.log -nsteps 5000
